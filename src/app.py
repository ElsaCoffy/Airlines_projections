...
HOME_AIRPORTS = ('LGW','LIS','LYS','PNH','SCL','SSA')
PAIRED_AIRPORTS = ('AMS','BCN','OPO','ORY','PIS','FUE','NGB','JFK','LHR','GRU')
...
if run_forecast: 
    ...
    if traffic_df.empty:
        ...
        st.markdown('## Graph of the total number of pax, and the forecasted data')
